...
namespace MeteoAPP.ViewModels
{
    public class MeteoListViewModel : BaseViewModel
    {
        ...
        public MeteoListViewModel(GeoLocationService locationService, IWeatherService weatherService)
        {
        ...
        public async Task LoadCitiesAsync()
        {
            try
            {
                ...
                Cities = cities == null ? new ObservableCollection<City>() : new ObservableCollection<City>(cities);
            }
            catch (Exception ex)
            {
